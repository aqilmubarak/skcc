<?php
//Script Author: masanto https://t.me/scssid
include 'config.php';
...
<body onload="ccgen();  onLoadChks();" style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
			...
			<div class="col-md-8">
				<form>
					...
					<div class="form-group" id="hidden_div" style="display:none;">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" style="border-color: #dc3545;background: transparent;color: <?php echo $theme_text ?>;" id="sk" aria-describedby="sk" placeholder="sk_live_xxxxxxxxxxxxxxxxxx" value="<?php if (isset($_COOKIE['sk_stored'])) {
																																																												echo $_COOKIE['sk_stored'];
																																																											} ?>">
							<div class="input-group-append">
		...
		<div class="footer" id="footer">
			<center>
				<p style="color: <?php echo $theme_text ?>">MASANTO - SCHT TEAM</p>
			</center>
		</div>
	</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
						...
						<div>
							<div class="row">
								<div class="col-12">
									...
									<div class="input-group mb-3">
										<input name="telebot" type="text" id="telebot" class="form-control" style="border-color: #dc3545;background: transparent;color: <?php echo $theme_text ?>" placeholder="Chat ID" value="<?php if (isset($_COOKIE['chatID_stored'])) {
																																																									echo $_COOKIE['chatID_stored'];
																																																								} ?>">
										<div class="input-group-append">
					...
					<div name="howto" id="howto">
						<center>
							...
							<h6 style="color: <?php echo $theme_text ?>;">[1] Open our Telegram Bot: <a href="http://t.me/akahikoBot" target="_blank">@akahikoBot</a>.
